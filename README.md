...
Code and data for our paper "Clone-Based Variability Management in the Android Ecosystem", presented in the 34th IEEE International Conference on Software Maintenance and Evolution (ICSME), 2018.
