...
public class File_Details {
     ...
     * @throws Exception 
     */
    public static int getIndex(String file, String sheetName) throws Exception {
        Workbook workbook = readFileName(file);
     ...
     * @throws Exception 
     */
    public static String setProjectName(String file, int sheet_index, String cellName) throws Exception {
        String projectName = "";
        try {
            CellReference pname = new CellReference(cellName);
            FileInputStream fisi = new FileInputStream(new File(file));
            XSSFWorkbook workbook = new XSSFWorkbook(fisi);
            FormulaEvaluator evaluator = workbook.getCreationHelper().createFormulaEvaluator();
            XSSFSheet sheets = workbook.getSheetAt(sheet_index);
